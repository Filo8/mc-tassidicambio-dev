...
public interface DownloadCsvApi {
    ...
    /**
     * POST /downloadCsv : Scarica in formato csv i tassi di cambio di tutte le divise passate in input, rispetto alla valuta e alla data di riferimento inserite nella richiesta.
     * 
     *
     * @param exchangeRatesRequest  (optional)
     * @return A csv file (status code 200)
    ...
    @Operation(
        ...
        tags = { "Exchange Rates" },
        responses = {
            @ApiResponse(responseCode = "200", description = "A csv file", content = {
    ...
    default ResponseEntity<org.springframework.core.io.Resource> exportExchangeRatesAsCsv(
